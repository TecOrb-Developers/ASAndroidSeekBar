...
public class Builder {
     ...
     *
     * @param showIndicatorType see{@link SeekBarIndicatorType}
     *                          IndicatorType.NONE;
    ...
    public Builder indicatorTextSize(int indicatorTextSize) {
        this.indicatorTextSize = Size.sp2px(context, indicatorTextSize);
        return this;
    }
    ...
    public Builder tickTextsSize(int tickTextsSize) {
        this.tickTextsSize = Size.sp2px(context, tickTextsSize);
        return this;
    }
    ...
    public Builder tickMarksSize(int tickMarksSize) {
        this.tickMarksSize = Size.dp2px(context, tickMarksSize);
        return this;
    }
