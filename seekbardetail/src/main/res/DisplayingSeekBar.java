...
import com.seekbardetail.Callback.SeekBarColorCollector;
import com.seekbardetail.FormatUtils;
import com.seekbardetail.DisplayValue;
...
public class DisplayingSeekBar extends View {
    ...
    private SeekBarProperty mSeekParams;//save the params when seeking change.
    //seek bar
    ...
    //indicator
    private DisplayValue mIndicator;//the pop window above the seek bar
    ...
    public void setThumbDrawable(Drawable drawable) {
        if (drawable == null) {
            ...
            this.mThumbRadius = Math.min(Size.dp2px(mContext, THUMB_MAX_WIDTH), mThumbSize) / 2.0f;
    ...
    public void setTickMarksDrawable(Drawable drawable) {
        if (drawable == null) {
            ...
            this.mTickRadius = Math.min(Size.dp2px(mContext, THUMB_MAX_WIDTH), mTickMarksSize) / 2.0f;
            this.mCustomDrawableMaxHeight = Math.max(mThumbTouchRadius, mTickRadius) * 2.0f;
            initTickMarksBitmap();
        }
        invalidate();
    ...
    public void customSectionTrackColor(@NonNull SeekBarColorCollector collector) {
